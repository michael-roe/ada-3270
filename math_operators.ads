package Math_Operators is
   ...
   Increment : constant Wide_Character := Wide_Character'Val (16#2206#);
   ...
   Logical_Or : constant Wide_Character := Wide_Character'Val (16#2228#);
   ...
   Less_Than_Or_Equal : constant Wide_Character :=
